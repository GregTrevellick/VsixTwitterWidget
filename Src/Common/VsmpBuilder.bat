...
rem FOR %%G IN (azure) DO (
FOR %%G IN (azure,azuredevops,ch9,code,codeproject,dailydotnettips,dev_humor,dotnet,dotnetcurry,dotnetfdn,dotnetkicks,mscloud,newsycombinator,nodejs,octopusdeploy,reddittech,thelivesoccer_,thelivesoccer_real,theregister,visualstudio,vsmdev,vsts,xamarinhq) DO (
